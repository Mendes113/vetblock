...
func ValidateHospitalization(hospitalization db.Hospitalization) error {
	validations := []struct {
		condition bool
		errMsg    string
	}{
...
func AddHospitalizationTransaction(hospitalization db.Hospitalization, sender, receiver string, amount float64) error {
